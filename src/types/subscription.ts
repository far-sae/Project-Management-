...
export const DEFAULT_PRICING: CountryPricing = {
  ...
  tiers: {
    ...
    basic: {
      ...
      promoMonths: 3,
      yearly: 63.9,
      stripePriceIdMonthly: "price_1T8nYMKw21TlmbMsSB6jjBOc",
      stripePriceIdMonthlyPromo: "price_1T8nj4Kw21TlmbMsh5nI9Aoy",
      stripePriceIdYearly: "price_1T8nlCKw21TlmbMsk08PzvNB",
      maxUsers: 3,
      extraUserPriceId: null,
      extraUserPrice: null,
    ...
    advanced: {
      ...
      promoMonths: 1,
      yearly: 480.0,
      stripePriceIdMonthly: "price_1T8nmGKw21TlmbMs4GXO6dCJ",
      stripePriceIdMonthlyPromo: "price_1T8o6VKw21TlmbMs6oymxx88",
      stripePriceIdYearly: "price_1T8oJkKw21TlmbMsB64ihBkr",
      maxUsers: 10,
      extraUserPriceId: "price_1T8o6VKw21TlmbMsr8CBK1TU",
      extraUserPrice: 2.99,
